...
export default function Home() {
  ...
  function navigate(item: string, path: string) {
    setActive(item);
      ...
      <aside className="sidebar">
        ...
        <nav>
          {["Dashboard", "Birds", "Breeding", "Inventory", "Sales", "Finance", "Reports"].map((item) => {
            const path = item === "Birds" ? "/birds" : "/";
            return <button key={item} className={active === item ? "nav-item active" : "nav-item"} onClick={() => navigate(item, path)}>
